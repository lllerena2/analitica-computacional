...
author:
  ...
  - name: Luis Llerena Sierra
  - name: Andrés Correa Pacheco
date: "3/20/2024"
lang: es
self-contained: true
fontsize: 14pt
...
*En la muestra se encuentran un total de 142 menores de 18 años, de los cuales 72 tienen el síndrome de ADHD y 70 no lo tienen. Esta submuestra está compuesta por 46 individuos de sexo femenino y 96 de sexo masculino.*
...
```{r}
# plot para mayores de edad con ADHD
...
*En la subpoblación de menores de edad que están diagnosticados con síndrome ADHD, no se observa ningún patrón en la distribución. Sin embargo, de las 50 tareas realizadas por estos individuos, la gran mayoría (19 de estas), tuvieron un éxito positivo de entre el 45 y 50%. Acerca de los individuos que no tienen ADHD, se observa una distribución sesgada hacia la derecha.*

*Al dividir la subpoblación en menores de edad del sexo masculino y femenino que tienen el síndrome ADHD se encontró que: el porcentajes de tareas finalizadas exitosamente por el sexo masculino sigue una distribución de campana, mientras que la del sexo femenino es sesgada hacia la izquierda.*
...
hist(subset(adhd_data, sexo=="M" & adhdstatus==1)$n_aciertos, main = "Número de aciertos")

```
```{r}
hist(subset(adhd_data, sexo=="F" & adhdstatus==1)$n_aciertos, main = "Número de aciertos")
```


```{r}
hist(subset(adhd_data, sexo=="M" & hyp==1)$n_aciertos, main = "Número de aciertos")
```

```{r}
hist(subset(adhd_data, sexo=="M" & ina==1)$n_aciertos, main = "Número de aciertos")
```

*La distribución de número de aciertos para los individuos diagnosticados con ADHD no es diferente dependiendo del generó, visualmente sus distribuciones son parecidas.*

*Para los niños, sexo masculino sin importar la edad, diagnosticados con ADHD se encontró que estos no o presentan hyp o ina, pero nunca las 2 condiciones.*
...
*Para los individuos que no fueron diagnosticados con ADHD, se observa una alta frecuencia en el valor igual a 1 de entropía, es decir, el diagnostico final en gran medida no puede ser determinado utilizando como base los resultados exitosos de las tareas asignadas. Mientras que para los individuos con ADHD, si bien hay una alta frecuencia en el valor de 1, también hay una cantidad importante de observaciones en 0.96 y 0.98 valores de entropía; lo que indicaría que sería posible establecer patrones y/o posibles diagnósticos para estos individuos basándose en los resultados satisfactorios de las tareas asignadas.*


*Según el sexo, los individuos del sexo masculino, se observa una alta frecuencia en el valor igual a 1 de entropía, es decir, el diagnostico final en gran medida no puede ser determinado utilizando como base los resultados exitosos de las tareas asignadas. Mientras que, para los individuos del sexo femenino, si bien hay una alta frecuencia en el valor de 1, también hay una cantidad importante de observaciones en 0.97 y 0.98 valores de entropía; lo que indicaría que sería posible establecer patrones y/o posibles diagnósticos para estos individuos basándose en los resultados satisfactorios de las tareas asignadas.*
### P6
